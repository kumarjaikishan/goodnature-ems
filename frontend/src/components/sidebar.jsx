...
import { MdOutlineEventNote, MdPayments, MdHistory, MdAccountBalanceWallet } from "react-icons/md";
      ...
      items: [
        ...
        { menu: "Payroll", link: "/dashboard/payroll", icon: <MdPayments />, roles: ["admin", "superadmin", "manager", "demo"] },
        {
          ...
          children: [
            ...
            { menu: "Plots Inventory", link: "/dashboard/plots/inventory", roles: ["admin", "superadmin", "manager", "demo"] },
