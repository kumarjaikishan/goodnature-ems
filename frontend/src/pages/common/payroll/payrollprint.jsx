...
export default function PayslipPrintPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-2 min-h-screen bg-gray-50 py-6 print:p-0 print:bg-white print:py-0">
      <style>{`
        @media print {
          @page {
            size: A4 portrait;
      ...
      {/* Top action bar */}
      <div className="flex justify-between items-center w-full max-w-[794px] mb-6 print:hidden">
        <button 
          onClick={() => window.history.back()}
          className="bg-white text-slate-700 px-4 py-2 rounded-lg shadow-sm border border-slate-200 hover:bg-slate-50 transition-all font-semibold text-sm flex items-center gap-2"
        >
          ← Back
        </button>
        <h1 className="text-lg font-bold text-slate-800">Salary Slip Preview</h1>
        <button 
          onClick={handlePrint}
          className="bg-slate-900 text-white px-5 py-2 rounded-lg shadow-md font-semibold text-sm hover:bg-slate-800 transition-all flex items-center gap-2"
        >
          Print Salary Slip
        </button>
      </div>

      {/* Main Container Wrapper (allows horizontal scroll on mobile preview) */}
      <div className="w-full max-w-[794px] overflow-x-auto p-1 bg-slate-100 md:p-4 rounded-lg border border-slate-200 shadow-inner flex justify-center print:p-0 print:bg-transparent print:border-none print:shadow-none">
        
        {/* Printable Area */}
        <div 
          ref={printRef}
          className="print-area relative bg-white shadow-xl border border-gray-200 p-8 md:p-10 overflow-hidden print:shadow-none print:border-none print:p-0 font-sans"
          style={{
            width: "794px",
            minHeight: "1050px",
        ...
        >
          ...
          {/* Header Section */}
          <div className="flex flex-row justify-between items-start border-b-2 border-slate-800 pb-4 mb-6 relative z-10">
            ...
            <div className="text-right">
              <h2 className="text-lg font-black text-slate-700 uppercase tracking-widest border-b border-slate-400 pb-0.5">
                Payslip
              </h2>
          ...
          {/* Employee Info Grid */}
          <div className="grid grid-cols-2 gap-x-8 gap-y-2 mb-6 bg-slate-50 p-4 rounded-lg border border-slate-100 relative z-10">
          ...
          <div className="mb-6 relative z-10">
            ...
            <div className="grid grid-cols-7 border border-slate-300 rounded overflow-hidden">
              {[
          ...
          <div className="grid grid-cols-2 border border-slate-800 rounded overflow-hidden mb-6 relative z-10">
          ...
          {/* Net Salary Summary */}
          <div className="bg-slate-800 text-white rounded-lg p-4 flex flex-row justify-between items-center mb-6 relative z-10 shadow-md">
            <div className="text-left">
              <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest mb-0.5">Net Salary Payable</p>
              <p className="text-xs font-medium italic opacity-90 capitalize">
          ...
          {/* Bottom Section */}
          <div className="mt-20 grid grid-cols-2 gap-12 relative z-10">
            ...
            <div className="text-center pt-6 border-t border-dashed border-slate-300 relative">
      ...
      {/* Bottom Print Controls (Non-Printable, fallback convenience) */}
      <div className="fixed bottom-8 right-8 no-print flex gap-3 print:hidden">
         <button 
          onClick={() => window.history.back()}
