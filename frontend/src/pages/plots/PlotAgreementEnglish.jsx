...
const PlotAgreementEnglish = ({
  ...
  return (
    <div className="space-y-4 text-slate-900 font-sans leading-relaxed text-[0.76rem] text-justify">

      {/* Stamp Paper Space (Page 1 Top) */}
      <div className="h-[90mm] print:h-[90mm] w-full flex flex-col items-center justify-center border-2 border-dashed border-slate-300 rounded-lg print:border-none mb-4 shrink-0 bg-slate-50/50 avoid-break">
      ...
      {/* Header Title */}
      <div className="text-center my-3 avoid-break">
        <h2 className="text-lg font-black uppercase tracking-wider text-slate-900 border-b-2 border-slate-900 inline-block pb-0.5 m-0">
          BUYER'S AGREEMENT
        </h2>
        <p className="text-[0.76rem] text-slate-800 mt-2 m-0 leading-relaxed">
      ...
      <div className="space-y-3 avoid-break">
        <p className="font-black text-center uppercase tracking-wider text-slate-900 my-2 text-[0.82rem]">
          BY AND BETWEEN
        </p>
        ...
        <p className="text-center italic text-[0.72rem] text-slate-700 m-0">
          (Hereinafter, the "Company" and the "Allottee" are collectively referred to as the "Parties" and individually as a "Party", as the context demands.)
        </p>
      </div>
      ...
      <div className="pt-2 text-center avoid-break">
      ...
      <div className="space-y-4 pt-2">
        ...
        <div className="space-y-1.5 avoid-break">
          ...
          <p className="m-0 leading-relaxed"><span className="font-bold">A. EVENTS OF DEFAULTS</span></p>
          <p className="m-0 leading-relaxed">
        ...
        <div className="space-y-1.5 avoid-break">
          ...
          <p className="m-0 leading-relaxed"><span className="font-bold">A. EXPECTED TIME FOR HANDING OVER POSSESSION</span></p>
          <p className="m-0 leading-relaxed">
          ...
          <p className="m-0 leading-relaxed pt-1.5"><span className="font-bold">8. ALLOTTEE'S OBLIGATION TO TAKE POSSESSION AND CONSEQUENCES OF FAILURE TO TAKE POSSESSION</span></p>
          <div className="pl-3 space-y-1">
        ...
        <div className="space-y-1.5 avoid-break">
          ...
          <p className="m-0 leading-relaxed"><span className="font-bold">A. FORCE MAJEURE</span><br />
          ...
          <p className="m-0 leading-relaxed"><span className="font-bold">B. SUSPENSION AS A RESULT OF FORCE MAJEURE</span><br />
          ...
          <p className="m-0 leading-relaxed"><span className="font-bold">C. ABANDONMENT OF THE PROJECT</span><br />
        ...
        <div className="space-y-1 avoid-break">
          ...
          <p className="m-0 leading-relaxed"><span className="font-bold">A. TERMS AND CONDITIONS BINDING ON TRANSFEREE/ASSIGNEE</span><br />
          ...
          <p className="m-0 leading-relaxed"><span className="font-bold">B. JOINT AND SEVERAL LIABILITY OF CO-ALLOTTEES</span><br />
        ...
        <div className="space-y-2 avoid-break">
          <div>
            <h5 className="font-bold text-slate-900 m-0 uppercase border-b border-slate-200">15. ENTIRE AGREEMENT</h5>
            <p className="m-0 leading-relaxed">
          ...
          <div>
            <h5 className="font-bold text-slate-900 m-0 uppercase border-b border-slate-200">16. RIGHT TO AMEND ANNEXURES</h5>
            <p className="m-0 leading-relaxed">
          ...
          <div>
            <h5 className="font-bold text-slate-900 m-0 uppercase border-b border-slate-200">17. DISPUTE RESOLUTION</h5>
            <p className="m-0 leading-relaxed">
          ...
          <div>
            <h5 className="font-bold text-slate-900 m-0 uppercase border-b border-slate-200">18. GOVERNING LAW & JURISDICTION</h5>
            <p className="m-0 leading-relaxed">
      ...
      <div className="pt-3 avoid-break">
        <p className="text-center italic font-semibold text-[0.74rem] m-0 mb-3">
        ...
        <div className="grid grid-cols-2 gap-4 text-[0.74rem] border border-slate-300 p-3 rounded bg-slate-50/50">
          <div className="space-y-4">
            <div>
              <p className="font-black text-slate-900 uppercase m-0">SIGNED & DELIVERED</p>
              <p className="text-slate-700 font-bold m-0 text-[0.72rem]">For & on behalf of {companyName}</p>
            </div>
            <div className="pt-6">
              <p className="font-bold text-slate-900 m-0">(Authorized Signatory)</p>
            </div>
            <div className="space-y-1 pt-2 border-t border-slate-200">
              <p className="font-bold text-slate-900 m-0 uppercase text-[0.7rem]">WITNESSES</p>
          ...
          <div className="space-y-4">
            <div>
              <p className="font-black text-slate-900 uppercase m-0">SIGNED & DELIVERED</p>
              <p className="text-slate-700 font-bold m-0 text-[0.72rem]">For & on behalf of the Allottee:</p>
            </div>
            <div className="space-y-1">
              <p className="font-bold text-slate-900 m-0">1. ___________________________ (Sign 1st Applicant)</p>
              <p className="m-0 text-[0.7rem]">Name: <span className="font-bold uppercase">{customerName}</span></p>
              <p className="font-bold text-slate-900 m-0 pt-2">2. ___________________________ * (Sign Co. Applicant)</p>
              <p className="m-0 text-[0.68rem] text-slate-500">*Applicable in the event of co-allottees</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Annexure 1 Table */}
      <div className="pt-3 avoid-break">
        <h4 className="font-black text-slate-900 text-[0.78rem] uppercase m-0 border-b border-slate-300 pb-0.5 text-center">ANNEXURE - 1</h4>
        <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 text-[0.72rem] border border-slate-300 p-3 rounded mt-2 bg-white">
          <div className="flex justify-between border-b border-slate-100 pb-0.5">
            <span className="font-bold text-slate-700">PROJECT LOCALITY:</span>
            <span className="font-semibold uppercase">{cityRajgir}</span>
          </div>
          <div className="flex justify-between border-b border-slate-100 pb-0.5">
            <span className="font-bold text-slate-700">PLAN:</span>
            <span className="font-semibold uppercase">{planCode}</span>
          </div>
          <div className="flex justify-between border-b border-slate-100 pb-0.5">
            <span className="font-bold text-slate-700">PLOT SIZE (SQFT):</span>
            <span className="font-semibold">{plotArea}</span>
          </div>
          <div className="flex justify-between border-b border-slate-100 pb-0.5">
            <span className="font-bold text-slate-700">PLOT VALUE:</span>
            <span className="font-bold text-slate-900">{formatCurrency(booking.plotValue || netPlotValue)}</span>
          </div>
          <div className="flex justify-between border-b border-slate-100 pb-0.5">
            <span className="font-bold text-slate-700">PLOT PAYMENT PLAN:</span>
            <span className="font-semibold uppercase">{booking.scheme === 'MONTHLY_INSTALLMENT' ? 'Installment' : (booking.scheme === 'FULL_PAYMENT' ? 'Full Payment' : 'Installment')}</span>
          </div>
          <div className="flex justify-between border-b border-slate-100 pb-0.5">
            <span className="font-bold text-slate-700">TOTAL PAYMENT RECEIVED:</span>
            <span className="font-bold text-slate-900">{formatCurrency(downpaymentAmount)}</span>
          </div>
          <div className="flex justify-between border-b border-slate-100 pb-0.5">
            <span className="font-bold text-slate-700">REST AMOUNT:</span>
            <span className="font-bold text-slate-900">{formatCurrency(remainingBalanceAmount)}</span>
          </div>
          <div className="flex justify-between border-b border-slate-100 pb-0.5">
            <span className="font-bold text-slate-700">EMI DURATION:</span>
            <span className="font-semibold">{installmentCount} installments</span>
          </div>
          <div className="flex justify-between border-b border-slate-100 pb-0.5">
            <span className="font-bold text-slate-700">EMI AMOUNT:</span>
            <span className="font-bold text-slate-900">{formatCurrency(standardEmiAmt)}</span>
          </div>
          <div className="flex justify-between border-b border-slate-100 pb-0.5">
            <span className="font-bold text-slate-700">PAYMENT MODE / DETAILS:</span>
            <span className="font-semibold uppercase">{booking.paymentMode || 'Wire Transfer / Cheque / DD'}</span>
          </div>
        </div>
      </div>
    </div>
