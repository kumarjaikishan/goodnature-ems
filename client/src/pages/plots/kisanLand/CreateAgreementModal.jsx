          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base md:text-lg font-bold text-slate-900">
                New Kisan Land Acquisition Agreement
              </h3>
              <p className="text-xs text-slate-500">
                Record land parcels, Chaudhi boundaries, Kisan owners, and upload document attachments.
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 bg-slate-50 p-3.5 rounded-2xl border border-slate-200/80">
            ...
            <div className="sm:col-span-2">
              ...
              <input
                type="text"
                placeholder="e.g. Sourced via Danapur circle, registry target within 3 months"
            ...
            <div className="space-y-3">
              {parcels.map((parcel, idx) => (
                ...
                >
                  ...
                  {/* Primary Parcel Identification Grid */}
                  ...
                  {/* Collapsible Chaudhi Directional Boundaries */}
                  {(activeChaudhiIdx === idx || Object.values(parcel.chaudhi || {}).some(Boolean)) && (
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between border-b border-slate-200/80 pb-2">
              <div className="flex items-center gap-2">
                ...
                <h4 className="text-xs md:text-sm font-bold text-slate-800 uppercase tracking-wider">
                  Kisan / Land Owner(s) Details ({(createForm.farmers || []).length})
                </h4>
              </div>
              <button
                type="button"
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-100">
            ...
            <div className="flex items-center gap-2.5">
              ...
              >
                {createLoading ? 'Saving Agreement...' : 'Save Kisan Land Agreement'}
              </button>
            </div>
          </div>
        </form>
