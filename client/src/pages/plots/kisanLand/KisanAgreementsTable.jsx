          ...
          <table className="w-full border-collapse text-left text-xs">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200 text-slate-500 font-semibold select-none">
                ...
                <th className="p-3.5 uppercase">Kisan / Land Owner</th>
              ...
              {agreements.length === 0 ? (
                <tr>
                  <td colSpan={8} className="p-8 text-center text-slate-400 italic">
                    No Kisan Land Agreements found matching criteria. Click "+ New Land Agreement" above to register one.
                  </td>
                </tr>
              ) : (
                agreements.map((agr) => {
                    ...
                    <tr key={agr._id} className="hover:bg-slate-50/80 transition">
                      ...
                      <td className="p-3.5">
                        ...
                        <div className="flex items-center gap-1 mt-1 flex-wrap">
                          ...
                          {attachmentsCount > 0 && (
                            <span
                              className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-[9px] font-bold bg-slate-100 text-slate-600 border border-slate-200"
                              title={`${attachmentsCount} Document(s) Attached`}
                            >
                      ...
                      <td className="p-3.5">
                        <div className="space-y-1.5">
                          ...
                          {agr.farmers && agr.farmers.length > 0 ? (
                            <div>
                              <div className="text-[9px] uppercase font-bold text-slate-400">Seller / Kisan:</div>
                              ...
                              {agr.farmers.length > 1 && (
                                <span className="inline-block mt-0.5 text-[9px] font-bold text-teal-700 bg-teal-50 px-1.5 py-0.5 rounded border border-teal-200">
                                  +{agr.farmers.length - 1} more farmer(s)
                                </span>
                              )}
                            </div>
                          ) : (
                      ...
                      <td className="p-3.5">
                        <div className="flex flex-col gap-1.5 items-start">
                          ...
                          <div className="flex items-center gap-1.5 flex-wrap">
                            {/* 4. Kisan Ledger */}
                            <button
                              onClick={() => navigate(`/dashboard/plots/agreements/${agr._id}/ledger`)}
