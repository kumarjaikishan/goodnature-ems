...
export const EditReceiptModal = ({
  ...
  return (
    <Modalbox open={Boolean(editingReceipt)} onClose={onClose}>
      <div className="p-6 bg-white rounded-2xl w-[600px] max-w-[90vw] space-y-4">
        <div className="flex justify-between items-center pb-3 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500">Update payment details and remarks</p>
          </div>
          <button
            type="button"
...
export const ApproveReceiptModal = ({
  ...
  return (
    <Modalbox open={Boolean(approvingReceipt)} onClose={onClose}>
      <div className="p-6 bg-white rounded-2xl w-[480px] max-w-[90vw] space-y-4">
        <div className="flex justify-between items-center pb-3 border-b border-slate-100 shrink-0">
          <h3 className="text-base font-bold text-emerald-800 flex items-center gap-2">
            Approve Collection: {approvingReceipt?.receiptNumber}
          </h3>
          <button
            type="button"
            className="text-slate-400 hover:text-slate-600 text-base font-bold cursor-pointer transition p-1"
...
export const RejectReceiptModal = ({
  ...
  return (
    <Modalbox open={Boolean(rejectingReceipt)} onClose={onClose}>
      <div className="p-6 bg-white rounded-2xl w-[480px] max-w-[90vw] space-y-4">
        <div className="flex justify-between items-center pb-3 border-b border-slate-100 shrink-0">
          <h3 className="text-base font-bold text-rose-700 flex items-center gap-2">
            Reject Collection: {rejectingReceipt?.receiptNumber}
          </h3>
          <button
            type="button"
            className="text-slate-400 hover:text-slate-600 text-base font-bold cursor-pointer transition p-1"
...
export const DeleteReceiptModal = ({
  ...
  return (
    <Modalbox open={Boolean(deletingReceipt)} onClose={onClose}>
