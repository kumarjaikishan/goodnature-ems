        ...
        <div className="flex justify-between items-start border-b-2 border-slate-900 pb-3 mb-4">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-black tracking-tight text-slate-900">RISEOWN</h1>
                <p className="text-[10px] text-gray-400">Marketing Pvt Ltd.</p>
              </div>
            </div>

            {/* Address & Details */}
            <div className="text-[10px] text-slate-600 space-y-0.5 font-medium">
              <p>Shri Krishna Nagar, Biyawani, Near Panchayat Bhawan, Bihar sharif, Nalanda, Bihar - 803118</p>
              <p><span className="font-bold text-slate-800">Contact:</span> 7766954518 | <span className="font-bold text-slate-800">GSTIN:</span> 10AAJCR9358L1ZX</p>
            </div>
          </div>
        </div>
