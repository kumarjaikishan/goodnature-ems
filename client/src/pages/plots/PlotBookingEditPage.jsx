            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-100 pb-3 gap-2">
              <div>
                <h3 className="text-base font-bold text-slate-800 flex items-center gap-2">
                  ...
                  <span>Land Acquisition Sourcing (किसान एग्रीमेंट / डीड स्टॉक) *</span>
                </h3>
                <p className="text-xs text-slate-500 mt-1">
                  Required: Sourced Area must match plot area ({plotArea} Sq.Ft.) from active Kisan Agreements or Deeds.
                </p>
              </div>
            ...
            {landSourcing.length === 0 ? (
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-amber-900">
                <div className="flex items-center gap-2">
                  ...
                  <span>No land source selected. Click &quot;+ Add Land Source&quot; to allocate stock.</span>
                </div>
                {availableLandSources.length > 0 && (
                  <Button
                    type="button"
