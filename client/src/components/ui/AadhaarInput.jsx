...
/**
 * Aadhaar Number Input Component
 * - Digits only, max 12 digits
 * - Formatted automatically with a space after every 4 digits (e.g. '1234 5678 9012')
 * - Opens numeric keypad on mobile devices
 */
export const AadhaarInput = forwardRef(({
  label,
  error,
  helperText,
  startIcon: StartIcon,
  ...
  // Format raw digits into 4-digit blocks separated by spaces
  ...
  const handleInputChange = (e) => {
    ...
    const formatted = formatAadhaar(digitsOnly);
  ...
  const handleKeyDown = (e) => {
    ...
    if (currentDigits.length >= 12 && !isSelection) {
      e.preventDefault();
    }
  };
      ...
      <div className="relative flex items-center w-full">
        ...
        <input
          ...
          className={`
            ...
            placeholder:text-slate-400 font-mono tracking-wider font-medium
